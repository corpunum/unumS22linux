...
| `/root/bluetooth_impl` | `/tmp/s22-luna-wave1-bt-20260923`, `codex/s22-wave1-bt-20260923` | Initial bridge/test commit `7bade3f376bb0e810baca799e4dc5ec8f17b2443` integrated as `c7c2080`; review follow-up `d3f50668ecf19c117a503f6cafaca19cc72df4e0` integrated as `82542fe`. H4 binaries now use per-run temp storage; capability-denial tests reject allow/no-op mutations; cleanup test name is precise. Coordinator reran H4 12/12 and exact-pinned-source HCI validator. No kernel build/runtime HCI. |
...
| `/root/bluetooth_independent_review` | `/tmp/s22-luna-review-bt-worker-20260923` (initial) and `/tmp/s22-luna-review-bt-followup-20260923` (`d3f50668ecf19c117a503f6cafaca19cc72df4e0`) | Initial independent Luna Max review complete: no C cleanup defect; flagged temp-path race, capability-denial mutation gap, and naming precision. Follow-up review of the fixes is active. HCI restoration patch remains unbuilt; no device/runtime proof. |
